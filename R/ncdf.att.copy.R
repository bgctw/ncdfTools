...
##description<< copies all attributes from one variable in a ncdf file to another variable
...
##seealso<<
##\code{\link{ncdf.fileatts.copy}}, \code{\link{ncdf.var.copy}}, \code{\link{attt.copy.nc}}
